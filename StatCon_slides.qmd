---
title: "**biplotEZ**"
subtitle: "User-friendly biplots in R<br><br><br> Centre for Multi-Dimensional Data Visualisation (MuViSU) <br>muvisu@sun.ac.za<br><br><br>**StatCon 2023**<br><br><br><br>**Code repository**: [https://github.com/MuViSU/biplotEZ_beta](https://github.com/MuViSU/biplotEZ_beta)"
format: 
  revealjs:
    self-contained: true
...
::: {layout-ncol="2"}
![](GlobalOptions.jpg){width="10%"}

![](GlobalOptionsPipe.jpg){width="25%"}
:::
:::
...
-   Use the preferred biplot: [PCA()]{style="font-family: 'Noto Sans Mono', monospace"} or [CVA()]{style="font-family: 'Noto Sans Mono', monospace"}, available in current version.
...
-   To visualise, end with [plot()]{style="font-family: 'Noto Sans Mono', monospace"}.
:::

Use pipe ( \|\> ) between each subsequent function. The order of [samples(), axes(), alpha.bags(), concentration.ellipse() and legend.type()]{style="font-family: 'Noto Sans Mono', monospace"} can be interchanged.

## [biplot()]{style="font-family: 'Noto Sans Mono', monospace"} - <font size="8">arguments</font>
...
## [biplot()]{style="font-family: 'Noto Sans Mono', monospace"} - <font size="8">print</font>
...
## [biplot()]{style="font-family: 'Noto Sans Mono', monospace"} - <font size="8">values</font>
...
## [PCA()]{style="font-family: 'Noto Sans Mono', monospace"} - <font size="8">arguments</font>
...
| [dim.biplot]{style="font-family: 'Noto Sans Mono', monospace"} | Dimension of the biplot. Only values 1, 2 and 3 are accepted, with default 2. *Only 2D in current version.*                                                       |
...
## [PCA()]{style="font-family: 'Noto Sans Mono', monospace"} - <font size="8">values</font>

```{r, echo = TRUE, eval = TRUE}
str(out)
```

## [PCA()]{style="font-family: 'Noto Sans Mono', monospace"} with [plot()]{style="font-family: 'Noto Sans Mono', monospace"} - <font size="8">simple</font>

```{r, echo = TRUE, eval = TRUE}
biplot(iris[,1:4]) |> PCA() |> plot()
```

## [PCA()]{style="font-family: 'Noto Sans Mono', monospace"} with [plot()]{style="font-family: 'Noto Sans Mono', monospace"} - <font size="8">groups</font>

```{r, echo = TRUE, eval = TRUE}
biplot(iris[,1:4], group.aes = iris[,5]) |> PCA() |> plot()
```

## [samples()]{style="font-family: 'Noto Sans Mono', monospace"} - <font size="8">arguments</font>
...
| [connected]{style="font-family: 'Noto Sans Mono', monospace"}  | Logical argument, whether samples are connected in order of rows of data matrix, with default ["FALSE"]{style="font-family: 'Noto Sans Mono', monospace"}. *Not in current version.* |
| [alpha]{style="font-family: 'Noto Sans Mono', monospace"}      | Opacity, with default [1]{style="font-family: 'Noto Sans Mono', monospace"}. *Not in current version.*                                                                               |

: {tbl-colwidths="\[25,75\]"}

## [samples()]{style="font-family: 'Noto Sans Mono', monospace"} - <font size="8">values</font>
...
## [PCA(), samples()]{style="font-family: 'Noto Sans Mono', monospace"} with [plot()]{style="font-family: 'Noto Sans Mono', monospace"}

```{r, echo = TRUE, eval = TRUE}
#changing the colour, plotting characters and size of the samples
biplot(iris[,1:4], group.aes = iris[,5]) |> PCA() |> samples(col = "purple", 
 pch = c(15,1,17), cex = 1.2) |> plot()
```

## [PCA(), samples()]{style="font-family: 'Noto Sans Mono', monospace"} with [plot()]{style="font-family: 'Noto Sans Mono', monospace"}

```{r, echo = TRUE, eval = TRUE}
#changing the grouping colours
#printing the sample names and changing the size
#omitting the plotting character
biplot(iris[,1:4], group.aes = iris[,5]) |> PCA() |> samples(label = TRUE, pch = "", 
  col = c("purple","magenta","blue"), label.cex=1) |> plot()
```

## [PCA(), samples()]{style="font-family: 'Noto Sans Mono', monospace"} with [plot()]{style="font-family: 'Noto Sans Mono', monospace"}

```{r, echo = TRUE, eval = TRUE}
#changing the side of the label
biplot(iris[,1:4], group.aes = iris[,5]) |> PCA() |> samples(label = TRUE, pch = "", 
  col = c("purple","magenta","blue"), label.side = "top") |> plot()
```
...
X <- iris[,1:4]
rownames(X) <- paste("s",rownames(iris),sep=":")
biplot(X, group.aes = iris[,5]) |> PCA() |> samples(label = TRUE, pch = "", 
  col = c("purple","magenta","blue")) |> plot()
```

## [axes()]{style="font-family: 'Noto Sans Mono', monospace"} - <font size="8">arguments</font>
...
|--------------------------------|----------------------------------------|
| [bp]{style="font-family: 'Noto Sans Mono', monospace"}      | Object of class [biplot]{style="font-family: 'Noto Sans Mono', monospace"}.                                   |
| [X.names]{style="font-family: 'Noto Sans Mono', monospace"} | Refers to the column names of [bp]{style="font-family: 'Noto Sans Mono', monospace"} to specify which axes to label. |
...
| [predict.col]{style="font-family: 'Noto Sans Mono', monospace"}       | Colour of lines showing orthogonal projection onto axes. *Not in current version.*                                                                                                                                               |
...
| Argument                                                        | Description                                                                            |
|-------------------------------------|-----------------------------------|
| [predict.lwd]{style="font-family: 'Noto Sans Mono', monospace"} | Line width of lines showing orthogonal projection onto axes. *Not in current version.* |
| [predict.lty]{style="font-family: 'Noto Sans Mono', monospace"} | Line type of lines showing orthogonal projection onto axes. *Not in current version.*  |
...
## [axes()]{style="font-family: 'Noto Sans Mono', monospace"} - <font size="8">values</font>
...
## [PCA()]{style="font-family: 'Noto Sans Mono', monospace"}, [axes()]{style="font-family: 'Noto Sans Mono', monospace"} with [plot()]{style="font-family: 'Noto Sans Mono', monospace"}

```{r, echo = TRUE, eval = TRUE}
#changing axes colour
...
```{r, echo = TRUE, eval = TRUE}
#displaying selected column names
biplot(iris[,1:4]) |> PCA() |> axes(col = "purple", X.names = c("Sepal.Length",
  "Petal.Width","Sepal.Width")) |> plot()
```

## [PCA()]{style="font-family: 'Noto Sans Mono', monospace"}, [axes()]{style="font-family: 'Noto Sans Mono', monospace"} with [plot()]{style="font-family: 'Noto Sans Mono', monospace"}

```{r, echo = TRUE, eval = TRUE}
#displaying selected axes
biplot(iris[,1:4]) |> PCA() |> axes(which = c(1,2,3), col = "black") |> plot()
```
...
```{r, echo = TRUE, eval = TRUE}
#displaying selected axes
#changing label direction and distance from plot
biplot(iris[,1:4]) |> PCA() |> axes(which = c(1,2,4), col = "black", 
  label.dir = "Paral", label.dist = 1) |> plot()
```

## [PCA()]{style="font-family: 'Noto Sans Mono', monospace"}, [axes()]{style="font-family: 'Noto Sans Mono', monospace"} with [plot()]{style="font-family: 'Noto Sans Mono', monospace"}

```{r, echo = TRUE, eval = TRUE}
#changing axes line width and axes label size
#changing tick colour and size
biplot(iris[,1:4], group.aes = iris[,5]) |> PCA() |> axes(col = "black", tick.col = 
  "black", tick.size = 1.2, tick.label.cex = 0.7, lwd = 1.5, label.cex = 1) |> plot()
```

## [PCA()]{style="font-family: 'Noto Sans Mono', monospace"}, [axes()]{style="font-family: 'Noto Sans Mono', monospace"} with [plot()]{style="font-family: 'Noto Sans Mono', monospace"}

```{r, echo = TRUE, eval = TRUE}
#changing tick colour, size and number of ticks
biplot(iris[,1:4], group.aes = iris[,5]) |> PCA() |> axes(col = "black", tick.col = 
  "black", tick.size = 1.2, ticks = 7, tick.label.col = "red", lwd = 1.2) |> plot()
```
## [PCA()]{style="font-family: 'Noto Sans Mono', monospace"}, [axes()]{style="font-family: 'Noto Sans Mono', monospace"} with [plot()]{style="font-family: 'Noto Sans Mono', monospace"}

```{r, echo = TRUE, eval = TRUE}
#changing tick mark positions
biplot(iris[,1:4], group.aes = iris[,5]) |> PCA() |> axes(col = "black", tick.col = 
  "black", tick.size = 1.2, ticks = 5, tick.label.pos = c(2,2,3,1), tick.label.offset = 
  c(0.4,0.4,0.4,0.8), lwd = 1.2) |> plot()
```
...
#changing axes names
biplot(iris[,1:4], group.aes = iris[,5]) |> PCA() |> axes(col = "black", tick.col = 
  "black", tick.size = 1.2, lwd = 1.2, ticks = 7, tick.label.pos = c(2,2,3,1), 
  tick.label.offset = c(0.4,0.4,0.4,0.8), ax.names = c("A", "B", "","D"), 
  label.dist = 1, label.dir = "Hor") |> plot()
```
## [PCA()]{style="font-family: 'Noto Sans Mono', monospace"}, [axes()]{style="font-family: 'Noto Sans Mono', monospace"} with [plot()]{style="font-family: 'Noto Sans Mono', monospace"}
...
biplot(iris[,1:4], group.aes = iris[,5]) |> PCA() |> axes(col = "black", tick.col = 
  "black", tick.size = 1.2, lwd = 1.2, ticks = 7, tick.label = FALSE) |> plot()
```

## [PCA()]{style="font-family: 'Noto Sans Mono', monospace"}, [axes()]{style="font-family: 'Noto Sans Mono', monospace"} with [plot()]{style="font-family: 'Noto Sans Mono', monospace"}

```{r, echo = TRUE, eval = TRUE}
#horizontal translation of axes
biplot(iris[,1:4], group.aes = iris[,5]) |> PCA() |> axes(col = "black", tick.col = 
  "black", tick.label.pos = c(2,2,3,1), tick.label.offset = c(0.4,0.4,0.4,0.8),
  orthogx = 2) |> plot()
```
## [PCA()]{style="font-family: 'Noto Sans Mono', monospace"}, [axes()]{style="font-family: 'Noto Sans Mono', monospace"} with [plot()]{style="font-family: 'Noto Sans Mono', monospace"}

```{r, echo = TRUE, eval = TRUE}
#vertical translation of axes
biplot(iris[,1:4], group.aes = iris[,5]) |> PCA() |> axes(col = "black", tick.col = 
  "black", tick.label.pos = c(2,2,3,1), tick.label.offset = c(0.4,0.4,0.4,0.8),
  orthogy = -2) |> plot()
```

## [alpha.bags()]{style="font-family: 'Noto Sans Mono', monospace"} - <font size="8">arguments</font>
...
## [alpha.bags()]{style="font-family: 'Noto Sans Mono', monospace"} - <font size="8">values</font>
...
## [PCA(),alpha.bags()]{style="font-family: 'Noto Sans Mono', monospace"} with [plot()]{style="font-family: 'Noto Sans Mono', monospace"}

```{r, echo = TRUE, eval = TRUE, results = "hide"}
#one alpha bag per group
biplot (iris[,1:4],group.aes=iris[,5]) |> PCA() |> alpha.bags(alpha=0.95) |> plot()
```
## [PCA(),alpha.bags()]{style="font-family: 'Noto Sans Mono', monospace"} with [plot()]{style="font-family: 'Noto Sans Mono', monospace"}

```{r, echo = TRUE, eval = TRUE, results = "hide"}
#three alpha bags for group 1 with different line types
biplot (iris[,1:4],group.aes = iris[,5]) |> PCA() |> alpha.bags(alpha = c(0.99,0.8,0.6),
  which = 1, lty = c(1,2,3)) |> plot()
```
## [PCA(),alpha.bags()]{style="font-family: 'Noto Sans Mono', monospace"} with [plot()]{style="font-family: 'Noto Sans Mono', monospace"}

```{r, echo = TRUE, eval = TRUE, results = "hide"}
#alpha bags for selected groups with different line types per alpha value
biplot (iris[,1:4],group.aes = iris[,5]) |> PCA() |> alpha.bags(alpha = c(0.95,0.6),
  which = c(1,2), lty = c(1,2,3)) |> plot()
```

## [PCA(),alpha.bags()]{style="font-family: 'Noto Sans Mono', monospace"} with [plot()]{style="font-family: 'Noto Sans Mono', monospace"}

```{r, echo = TRUE, eval = TRUE, results = "hide"}
#three alpha bags per group with different line types per alpha value
biplot (iris[,1:4],group.aes = iris[,5]) |> PCA() |> alpha.bags(alpha = c(0.99,0.8,0.6)
  ,lty = c(1,2,3)) |> plot()
```
...
```{r, echo = TRUE, eval = TRUE, results = "hide"}
#changing alpha bag colours
#changing sample colour
biplot (iris[,1:4],group.aes = iris[,5]) |> PCA() |> alpha.bags(alpha = c(0.99,0.8,0.6), 
  lty = c(1,2,3), col = c("purple","magenta","blue")) |> samples(col = "grey")|> plot()
```

## [concentration.ellipse()]{style="font-family: 'Noto Sans Mono', monospace"} - <font size="8">arguments</font>
...
|-----------------------|-------------------------------------------------|
| [bp]{style="font-family: 'Noto Sans Mono', monospace"}    | Object of class [biplot]{style="font-family: 'Noto Sans Mono', monospace"}.               |
| [df]{style="font-family: 'Noto Sans Mono', monospace"}    | Degrees of freedom to calculate kappa from alpha, with default [2]{style="font-family: 'Noto Sans Mono', monospace"}.   |
| [kappa]{style="font-family: 'Noto Sans Mono', monospace"} | Value to construct kappa-ellipse. This will overwrite a given value of [alpha]{style="font-family: 'Noto Sans Mono', monospace"}  and [df]{style="font-family: 'Noto Sans Mono', monospace"} .                                                         |
| [which]{style="font-family: 'Noto Sans Mono', monospace"} | The selection of the group for ellipse construction.                                      |
| [alpha]{style="font-family: 'Noto Sans Mono', monospace"} | Size of alpha-bag, with default [0.95]{style="font-family: 'Noto Sans Mono', monospace"}. |
...
| Argument                                                               | Description            |
|-----------------------|-------------------------------------------------|
| [col]{style="font-family: 'Noto Sans Mono', monospace"}                | Colour of ellipse.     |
| [lty]{style="font-family: 'Noto Sans Mono', monospace"}                | Line type of ellipse.  |
| [lwd]{style="font-family: 'Noto Sans Mono', monospace"}                | Line width of ellipse. |
| [alpha.transparency]{style="font-family: 'Noto Sans Mono', monospace"} | Level of opacity. *Not in current version.*      |

: {tbl-colwidths="\[30,70\]"}

## [concentration.ellipse()]{style="font-family: 'Noto Sans Mono', monospace"} - <font size="8">values</font>
...
## [PCA(),concentration.ellipse()]{style="font-family: 'Noto Sans Mono', monospace"} with [plot()]{style="font-family: 'Noto Sans Mono', monospace"}

```{r, echo = TRUE, eval = TRUE, results = "hide"}
#one kappa ellipse per group
biplot (iris[,1:4]) |> PCA(group.aes = iris[,5]) |> concentration.ellipse(kappa = 2) |> plot()
```
## [PCA(),concentration.ellipse()]{style="font-family: 'Noto Sans Mono', monospace"} with [plot()]{style="font-family: 'Noto Sans Mono', monospace"}

```{r, echo = TRUE, eval = TRUE, results = "hide"}
#chaning the degrees of freedom for the kappa value calculation using alpha
biplot (iris[,1:4]) |> PCA(group.aes = iris[,5]) |> concentration.ellipse(alpha = 0.95,
  df = 2) |> plot()
```
## [PCA(),concentration.ellipse()]{style="font-family: 'Noto Sans Mono', monospace"} with [plot()]{style="font-family: 'Noto Sans Mono', monospace"}

```{r, echo = TRUE, eval = TRUE, results = "hide"}
#three kappa ellipses per group with different line types per kappa value
biplot (iris[,1:4]) |> PCA(group.aes = iris[,5]) |> concentration.ellipse(kappa = c(2,3,4),
  lty = c(1,2,3)) |> plot()
```
## [PCA(),concentration.ellipse(), alpha.bags()]{style="font-family: 'Noto Sans Mono', monospace"} with [plot()]{style="font-family: 'Noto Sans Mono', monospace"}

```{r, echo = TRUE, eval = TRUE, results = "hide"}
#one alpha bag and kappa ellipse per group
biplot (iris[,1:4]) |> PCA(group.aes = iris[,5]) |> concentration.ellipse(kappa = 2.45, 
  lty = 2) |> alpha.bags(alpha = 0.95) |> plot()
```

## [legend.type()]{style="font-family: 'Noto Sans Mono', monospace"} - <font size="8">arguments</font>
...
| [means]{style="font-family: 'Noto Sans Mono', monospace"}   | Logical argument, whether legend should be printed for means, with default ["FALSE"]{style="font-family: 'Noto Sans Mono', monospace"}.   *Not in current version*.|
...
## [legend.type()]{style="font-family: 'Noto Sans Mono', monospace"}

```{r, echo = TRUE, eval = TRUE}
biplot (iris[,1:4], group.aes = iris[,5], Title = "Test biplot") |> PCA() |> 
  samples(pch = c(17,15,16)) |> legend.type(samples = TRUE) |> plot()
```
## [legend.type()]{style="font-family: 'Noto Sans Mono', monospace"}

```{r, echo = TRUE, eval = TRUE, results = "hide"}
#include legend for alpha bags and kappa ellipses
biplot (iris[,1:4]) |> PCA(group.aes=iris[,5]) |> concentration.ellipse(kappa = 2.45,
  lty = 2) |> alpha.bags(alpha = 0.95) |> legend.type(bags = TRUE, ellipses = TRUE) |> plot()
```
## [legend.type()]{style="font-family: 'Noto Sans Mono', monospace"}

```{r, echo = TRUE, eval = TRUE, results='hide', out.width="150%"}
#| layout-ncol: 2
#| column: page

#include legend in a separate plot
biplot (iris[,1:4]) |> PCA(group.aes=iris[,5]) |> concentration.ellipse(kappa = 2.45, 
  lty = 2) |> alpha.bags(alpha = 0.95) |> legend.type(bags = TRUE, ellipses = TRUE, 
  new = TRUE) |> plot()
```
...
The observed values of the $p$ canonical variables for an observation with measurement vector ${\bf{x}}$ are given by the elements of the vector,
...
In a CVA biplot, the observations belonging to different groups are represented as points. For any sample point ${\bf{x}}$, it is represented in the two-dimensional CVA biplot by the first two columns of ${\bf{x}}'{\bf{M}}$. Observations that are close together
in the biplot are similar in their scores on the first two canonical variables, while observations that are far apart are dissimilar. 

## Representing variables
The original measured variables can then be expressed as functions of the canonical variables:

$$ {\bf{x}} = {\bf{y}}'{\bf{M}}^{-1} $$ 

The variables are represented as vectors, with the direction of each vector indicating the role of the variable in discriminating between the groups. We use the above to construct prediction biplot axes to represent the $p$ variables. 



## Calibrated biplot axes

The vectors can be calibrated for prediction. The position of the marker point for predicting a certain value $\mu$ on the $i$-th variable is given by


$$ \frac{\mu}{{\bf{e}}_i' ({\bf{M}}^{-1})'{\bf{J}}{\bf{M}}^{-1}{\bf{e}}_i} {\bf{e}}_i' ({\bf{M}}^{-1})' {\bf{J}} $$
...
```{r}
biplot(Diabetes[,1:5], group.aes = Diabetes[,6]) |> CVA() |> axes(label.dist = 0.2) |>  plot()
```



## [CVA()]{style="font-family: 'Noto Sans Mono', monospace"} - <font size="8">arguments</font>
...
| Argument                                                       | Description                                                                      |
|-------------------------|-----------------------------------------------|
| [bp]{style="font-family: 'Noto Sans Mono', monospace"}         | Object of class biplot obtained from preceding function biplot().                |
| [dim.biplot]{style="font-family: 'Noto Sans Mono', monospace"} | Dimension of the biplot. Only values 1, 2 and 3 are accepted, with default 2.  *Only 2D in current version*.  |
| [e.vects]{style="font-family: 'Noto Sans Mono', monospace"}    | Which eigenvectors (principal components) to extract, with default 1:dim.biplot. *Only 2D in current version*. |
...
| Argument                                                        | Description                                                                                                                         |
|-------------------------|-----------------------------------------------|
| [group.aes]{style="font-family: 'Noto Sans Mono', monospace"}   | Vector of the same length as the number of rows in the data matrix for differentiated aesthetics for samples.                       |
| [weightedCVA]{style="font-family: 'Noto Sans Mono', monospace"} | The default is "weighted", specifying a weighted CVA to be performed. Other possible values are "unweightedI" and "unweightedCent". *When group sizes are similar, weighting will have a minimal effect*. |

: {tbl-colwidths="\[25,75\]"}

## [CVA()]{style="font-family: 'Noto Sans Mono', monospace"} with [plot()]{style="font-family: 'Noto Sans Mono', monospace"} - <font size="8">groups</font>

```{r, echo = TRUE, eval = TRUE}
biplot(Diabetes[,3:5], group.aes = Diabetes[,6]) |> CVA() |>  axes(tick.label.pos
  = c(1,2,1,4), tick.label.offset = c(0.7,0.2,0.4,1), label.dist = 0.2) |> plot()
```
...
-   We hope this is the start of many EZ biplot constructions!