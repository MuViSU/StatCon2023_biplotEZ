...
#changing the opacity of sample plotting characters
#connecting samples
biplot(iris[,1:4], group.aes = iris[,5]) |> PCA() |> 
  samples(connected = TRUE, alpha = 0.5) |> plot()
```
...
```{r, echo = TRUE, eval = TRUE}
biplot(iris[,1:4], group.aes = iris[,5]) |> PCA() |> axes(col="black", tick.col = 
  "black", tick.size = 1.2, lwd = 1.2, ticks = 7, ax.names = c("A", "B", "","D")) |> plot()
```
...
|-----------------------|-------------------------------------------------|
| [bp]{style="font-family: 'Noto Sans Mono', monospace"}    | Object of class [biplot]{style="font-family: 'Noto Sans Mono', monospace"}.               |
| [df]{style="font-family: 'Noto Sans Mono', monospace"}    | Degrees of freedom, with default [2]{style="font-family: 'Noto Sans Mono', monospace"}.   |
| [kappa]{style="font-family: 'Noto Sans Mono', monospace"} | Value to construct kappa-ellipse.                                                         |
...
| [alpha.transparency]{style="font-family: 'Noto Sans Mono', monospace"} | Level of opacity.      |
