...
```{r, echo = TRUE, eval = TRUE}
#changing the colour of samples
#changing the plotting characters of the samples
#changing the expansion of the plotting characters of the samples
...
|--------------------------------|----------------------------------------|
| [bp]{style="font-family: 'Noto Sans Mono', monospace"}      | Object of class [biplot]{style="font-family: 'Noto Sans Mono', monospace"}.                                   |
| [X.names]{style="font-family: 'Noto Sans Mono', monospace"} | Specify which axes should include the column names of [bp]{style="font-family: 'Noto Sans Mono', monospace"}. |
...
```{r, echo = TRUE, eval = TRUE}
biplot(iris[,1:4], group.aes = iris[,5]) |> PCA() |> axes(col = "black", tick.col = 
  "black", tick.size = 1.2, lwd = 1.2, ticks = 7, tick.label.col = "red") |> plot()
```
...
```{r, echo = TRUE, eval = TRUE}
biplot(iris[,1:4], group.aes = iris[,5]) |> PCA() |> axes(col = "black", tick.col = 
  "black", tick.size = 1.2, lwd = 1.2, ticks = 7, tick.label = FALSE, orthogx = 2) |> plot()
```
## [PCA()]{style="font-family: 'Noto Sans Mono', monospace"}, [axes()]{style="font-family: 'Noto Sans Mono', monospace"} with [plot()]{style="font-family: 'Noto Sans Mono', monospace"}
