...
::: incremental
-   The biplot is a powerful and very useful data visualisation tool. Biplots makes information in a table of data become transparent, revealing the main structures in the data in a methodical way, for example patterns of correlations between variables or similarities between the observations.
